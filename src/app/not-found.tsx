...
import { uiContent } from '@/content/en/ui'
        ...
        <SiteShell lang="en">
            <div className="flex flex-col items-center justify-center space-y-8 py-24 text-center">
                <div className="space-y-4">
                    ...
                    <h2 className="text-3xl font-semibold tracking-tight">{uiContent.notFound.heading}</h2>
                    <p className="mx-auto max-w-md text-white/60">{uiContent.notFound.body}</p>
                </div>
