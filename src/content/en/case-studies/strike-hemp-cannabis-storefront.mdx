...
gallery:
  - id: product-catalog-grid
    status: ready
    src: /images/case-studies/product-catalog-grid.webp
    alt: Strike storefront homepage showing the full product catalog grid across categories like vape disposables, cartridges, dabs, flowers, and gummies
  - id: strain-filtering
    status: ready
    src: /images/case-studies/strain-filtering.webp
    alt: Strike product page with strain-based filtering controls and strain variant pills
  - id: coa-certificate
    status: ready
    src: /images/case-studies/coa-certificate.webp
    alt: Strike Certificate of Authenticity page listing lab-verified product lines with linked certificates
